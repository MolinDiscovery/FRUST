"""Built-in tsguess3 role-coordinate and constraint specifications."""
...
class TSGuess3Spec:
    """TS guess instructions for the fragment-aware SMILES backend.
...
BUILTIN_TS_SPECS_V3: dict[str, TSGuess3Spec] = {
    "TS1": TSGuess3Spec(
        name="TS1",
        spec_id="TS1::builtin::methylpyrrole_v3",
        builder_key="ts1_ts2",
        core_smarts="[#1]~[#7]~[*]~[*]~[#5]~[#6]",
        role_coordinates={
    ...
    "TS2": TSGuess3Spec(
        name="TS2",
        spec_id="TS2::builtin::methylpyrrole_v3",
        builder_key="ts1_ts2",
        core_smarts="[#1]~[#7]~[*]~[*]~[#5]~[#6]",
        role_coordinates={
    ...
    "TS3": TSGuess3Spec(
        name="TS3",
        spec_id="TS3::builtin::methylpyrrole_tmp_v3",
        builder_key="ts3_ts4",
        core_smarts="[#5]~[#1]~[#5]~[#6]",
        role_coordinates={
    ...
    "TS4": TSGuess3Spec(
        name="TS4",
        spec_id="TS4::builtin::methylpyrrole_tmp_v3",
        builder_key="ts3_ts4",
        core_smarts="[#5]~[#1]~[#5]~[#6]",
        role_coordinates={
